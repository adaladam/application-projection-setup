...
type Action =
  ...
  | "ACT_TAKE_NOTE"
  | "ACT_TAKE_NOTE_OWNER"
  | "ACT_DOCUMENT_SIGNATURE"
  | "ACT_GENERATE_TESTING_ACT"
  | "ACT_SERVICE_PUBLICATION"
  | "ACT_REGISTER_GROUP_ACTION"
  | "ACT_SIGNATURE_TESTING_ACT"
  | "ACT_SERVICE_EPIR_PUBLICATION"
  | "ACT_SIGNATURE_NEW_VERSION_DRAFT"
  | "ACT_SIGNATURE_APPLICATION_AND_AGREEMENT"
  | "ACT_SIGNATURE_NEW_VERSION_DRAFT_WITH_TESTING_ACT"
  | "ACT_SIGNATURE_APPLICATION_AND_AGREEMENT_WITH_TESTING_ACT";
